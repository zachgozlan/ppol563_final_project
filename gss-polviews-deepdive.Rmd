...
And considering we're basically talking about indicators of income here anyway, here is where the 2018 
...
relative_standing2 <- ggplot(data=gss_means, aes(x=age_wmean_binned, y=conrinc_median,
  ...
  labs(title="Is there something up with today's under-40 set?", subtitle="Age vs. Inflation-Adjusted Income (2018 Survey Highlighted)")

relative_standing2
```
<i>Individuals between the ages of 20 and 35 are relatively broke, but 36-40 year olds - who fit the pattern described above - seem to be doing fine.</i>
