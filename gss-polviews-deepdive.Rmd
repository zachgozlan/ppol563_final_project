...
<ol>
  <li>Birth years were condensed into five-year groups: birth cohort '1950', for example, contains everyone born between 1950 and 1954.</li>
...
polview_age <- ggplotly(polviews_age, tooltip=c("text"))  %>%
  layout(title = list(text = paste0('Political views of age cohorts by survey year',
                                    '<br>',
                                    '<sup>',
                                    '',
                                    '</sup>')))
